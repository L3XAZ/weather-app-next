...
describe('AddCityForm (extended)', () => {
    ...
    test('invalid name triggers toast.error', async () => {
        ...
        await waitFor(() =>
            expect(toast.error).toHaveBeenCalledWith('No lights on that skyline. Try again.')
        );
    });
    ...
    test('duplicate city triggers toast.error', async () => {
        ...
        await waitFor(() => expect(toast.error).toHaveBeenCalledWith('Almost! Check the name.'));
    });
    ...
    test('successful city addition triggers toast.success', async () => {
        ...
        await waitFor(() =>
            expect(toast.success).toHaveBeenCalledWith('A new point on your horizon!')
        );
    });
    ...
    test('API error triggers toast.error and error message', async () => {
        ...
        await waitFor(() =>
            expect(toast.error).toHaveBeenCalledWith('No skies responded. Try again.')
        );
