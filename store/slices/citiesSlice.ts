...
import { addCityToLS, deleteCityFromLS } from "@/lib/localStorage";
...
export const { setCities, addCity, deleteCity, selectCity, unselectCity } =
    citiesSlice.actions;

export const selectCities = (state: { cities: CitiesState }) => state.cities.cities;
export const selectSelectedCity = (state: { cities: CitiesState }) =>
